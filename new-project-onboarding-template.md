...
| **Domain**          | **daretobreakfree.com** (registered, pointing to Vercel)                           |
| **Email**           | [hello@daretobreakfree.com](mailto:hello@daretobreakfree.com) via Google Workspace |
| **Forms / contact** | Formspree endpoint for `/contact` and `/share-your-story`                          |
| **Repo path**       | `github.com/kalih/dtbf-site`                                                       |
| **Live URL**        | [https://daretobreakfree.com](https://daretobreakfree.com) (TBD)                   |
| **GitHub repo**     | [https://github.com/kalih/dtbf-site](https://github.com/kalih/dtbf-site)           |
...
2. Implement newsletter + contact endpoints via Resend.
3. Deploy MVP to Vercel and share preview.
...
> **Next Step** – use Codex to scaffold `/share-your-story` page with the provided excerpt and a contact form that posts to Resend.
